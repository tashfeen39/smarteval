...
from .models import AssignmentMarks, ClassRoom, ClassTiming, Complaint, Course, Degree, Department, Feedback, PresentationMarks, Program, QuizMarks, School, SemesterCourseGrade, SemesterCourses, SemesterDetails, SemesterMarksData, TeacherCoursesTaught, TeacherSectionsTaught, User, Student, Teacher, SemesterDetails, Section, Class
...
class QuizMarksAdmin(admin.ModelAdmin):
    pass

class PresentationMarksAdmin(admin.ModelAdmin): pass
...
admin.site.register(SemesterMarksData, SemesterMarksDataAdmin)
